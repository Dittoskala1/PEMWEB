...
<head>
    ...
    <title>Data Pelanggan - Dittoskala</title>
...
<body class="min-h-screen flex items-center justify-center font-[Inter] text-white">
    ...
    <section class="text-center px-6 max-w-xl mx-auto">
        ...
        <p class="text-lg mb-12 drop-shadow-md">
            Solusi cerdas untuk mencatat, mengelola, dan memantau informasi pelanggan dengan teknologi modern.
        </p>
            ...
            <div>
                @auth
                    <a href="{{ route('filament.admin.pages.dashboard') }}"
                       class="px-8 py-3 rounded-full bg-indigo-600 hover:bg-indigo-700 text-white font-semibold shadow-lg transition transform hover:scale-105">
                        Masuk ke Dashboard
                    </a>
                @else
                    <a href="{{ route('filament.admin.auth.login') }}"
                       class="px-8 py-3 rounded-full bg-gradient-to-r from-green-400 via-blue-500 to-purple-600 text-white font-semibold shadow-lg transition transform hover:scale-105 hover:brightness-110">
                        Login
                    </a>
                @endauth
            </div>
